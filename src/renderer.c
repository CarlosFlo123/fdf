...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/08 05:06:23 by cflores-          #+#    #+#             */
/*   Updated: 2018/12/08 05:06:29 by cflores-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_everything(t_data *d)
{
	...
	d->xtrans = 0;
	d->mlx = mlx_init();
	d->win = mlx_new_window(d->mlx, WINDOW_SIZE_X, WINDOW_SIZE_Y, "FDF - 42 Silicon Valley - cflores");
	init_color_table(d);
	setup_world(d);
